      ...
      <li class="nav-item">
        ...
        <div id="collapseUtilities" class="collapse" aria-labelledby="headingUtilities" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="utilities-color.html"><i class="fas fa-box"></i> Pedidos</a>
            <a class="collapse-item" href="utilities-border.html"><i class="fas fa-truck"></i> Envios</a>
          </div>
        </div>
      </li>
      <!-- Nav Item - Dashboard -->
